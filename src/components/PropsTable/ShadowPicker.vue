  ...
  <div class="component-shadow-picker">
    <div class="shadow-item">
      ...
      <div class="shadow-component">
        <ColorPicker :value="values[3]" @change="(v) => { updateValue(v, 3) }" />
      </div>
    </div>
    <div class="shadow-item">
      <span>阴影大小:</span>
      <div class="shadow-component">
        <a-slider
          :value="parseInt(values[0])" :min="0" :max="20"
          @change="(v: string | number) => { updateValue(v, [0, 1]) }"
        />
      </div>
    </div>
    <div class="shadow-item">
      ...
      <div class="shadow-component">
        <a-slider
          :value="parseInt(values[2])" :min="0" :max="20"
          @change="(v: string | number) => { updateValue(v, 2) }"
        />
      </div>
    </div>
  </div>
...
</style>: string | number: string | number
