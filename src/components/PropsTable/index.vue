      ...
      return reduce(props.props, (result, value, key) => {
        ...
        if (item) {
          ...
          const newItem: FormProps = {
            ...
            eventName,
            events: {
              [eventName]: (e: any) => { ctx.emit('change', { key, value: afterTransform ? afterTransform(e) : e }) },
            },
          }
...
.prop-component.component-shadow-picker, .prop-component.component-image-processor, .prop-component.component-background-processor {
  width: 100%;
}
</style>./ImageProcessor.vue
